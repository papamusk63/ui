...
function wrapStr(endWrap,fontSizeStr,whichString) {
	...
	if (endWrap) return (hasDims&&!olNs4) ? (isClose ? '</span>' : '</div>') : '</font>';
		...
		return (hasDims&&!olNs4) ? (isClose ? '<span style="font-family: '+quoteMultiNameFonts(eval(fontStr))+'; color: #FFFFFF; font-size: '+fontSizeStr+';">' : '<div style="font-family: '+quoteMultiNameFonts(eval(fontStr))+'; color: #FFFFFF; font-size: '+fontSizeStr+';">') : '<font face="'+eval(fontStr)+'" color="#FFFFFF" size="'+(parseInt(fontSizeStr)>7 ? '7' : fontSizeStr)+'">';
	}
}
